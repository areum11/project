...
const Prescription = props => (
  <tr>
      ...
      <td className="text-right">
        <a href="#!" onClick={() => { props.editPrescription(props.prescription._id) }}> edit </a> | <a href="#!" onClick={() => { props.deletePrescription(props.prescription._id) }}> delete </a>
          {/* <Link to={"/admin/user-page"}> edit </Link> | <a href="#!" onClick={() => { props.deletePrescription(props.prescription._id) }}> delete </a> */}
      </td>
  </tr>
);
...
export default class User extends Component{
  ...
  prescriptionList() {
    return this.state.prescription.map(currentprescription => {
        return <Prescription prescription={currentprescription} editPrescription={this.editPrescription} deletePrescription={this.deletePrescription} key={currentprescription._id}/>
    });
  }
